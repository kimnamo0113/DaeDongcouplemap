...
$(function() {
	...
	$('input').blur(function(){
	    ...
	    if($(this).attr('id') == 'id'){
           ...
           $.post('join/id',{gId:strId},function(result){
               if(result) {
            	   $("#id").next().next().show();
            	   $('#id').addClass("redBorder");
                   return false 
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" id="f1" action="join" method="POST">
                ...
                <div class="form-group">
                  <input type="id" class="form-control form-control-user" name="gId" id="id" placeholder="Id" autocomplete=”off”>
                  <p class="regExpMsg">형식이 올바르지 않습니다.(4~15)</p>
                   <p class="repeatMsg">중복된 Id입니다.</p>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="password" class="form-control form-control-user" name="gPassword" id="password1" placeholder="Password" autocomplete=”off”>
                    <p class="regExpMsg">형식이 올바르지 않습니다.(4~15)</p>
                  </div>
                  <div class="col-sm-6">
