...
//	}
//
//	if(updatePossible && window.mapData && typeof window.mapData[0] == "object" && !window.mapData[0].length && !window.mapData[0].items)
//		dataTabStr = objectToString(window.mapData);
//	else{
...
//		chart = document.getElementById("map1");
//	
